    ...
    def on_event(self, event, extension):
        ...
        try:
            ...
            if currency != last_currency or delta.total_seconds() > 60:
                # formulate request
                req = urllib.request.Request(api_info[1], headers={'User-Agent':'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36'})
